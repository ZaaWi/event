    ...
    */
    public function form($id = NULL)
    {
        ...
        $data['fees']      = array(
            ...
            'readonly'      => 'readonly',
            'class'         => 'form-control',
            'value'         => $this->form_validation->set_value('fees', !empty($result->fees) ? $result->fees : ''),
        );
        $data['net_fees']      = array(
            'name'          => 'net_fees',
            'id'            => 'net_fees',
            ...
            'readonly'      => 'readonly',
            'class'         => 'form-control',
            'value'         => $this->form_validation->set_value('net_fees', !empty($result->net_fees) ? $result->net_fees : ''),
        );
